 ...
 * <p>Titolo: Cell
 *
 * <p>Descrizione: La classe Cell viene utilizzata per gestire le celle della scacchiera all'interno
 * del gioco. Ogni cella contiene un pezzo e puo' essere svuotata o riempita a seconda delle
 * necessita'. Contiene inoltre un metodo che permette di convertire il pezzo in stringa per poterlo
 * stampare.
 *
